...
//    var feedItem: FeedItemModel!
    ...
    func configureContent(title: String?, feedItem model: Article, feedModel: FeedModel?) {
        ...
        let htmlString = "<!DOCTYPE html><html><head><meta charset=utf-8><meta name=viewport content=\"width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0, user-scalable=no\"><meta http-equiv=X-UA-Compatible content=IE=edge><title></title></head><body><header style=heardInfo><a class=title>\(feedTitle)</a><a class=author>\(feedAuthor)</a><a class=pub-date>\("发布于" + feedDate.usePlaceholdStringWhileIsEmpty("未知时间"))</a><div class=divider></div></header><div class=article-content>\(feedContent)</div>"
