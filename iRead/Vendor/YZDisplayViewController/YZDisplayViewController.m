...
- (UIScrollView *)contentScrollView
{
    if (_contentScrollView == nil) {
        ...
        _contentScrollView.bounces = true;
...
- (void)setTitleScrollViewBackgroundImageView:(UIImageView *)titleScrollViewBackgroundImageView {
    
    _titleScrollViewBackgroundImageView = titleScrollViewBackgroundImageView;
    [self.titleScrollView addSubview:_titleScrollViewBackgroundImageView];
...
- (void)viewDidLayoutSubviews
{
    ...
    self.titleScrollViewBackgroundImageView.frame = CGRectMake(0, 0, YZScreenW, YZTitleScrollViewH);
